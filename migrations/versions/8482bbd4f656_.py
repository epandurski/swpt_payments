...
Revision ID: 8482bbd4f656
Revises: 953d40d6b4e6
Create Date: 2019-08-26 19:39:50.861323
...
def upgrade():
    ...
    sa.Column('offer_id', sa.BigInteger(), nullable=False),
    sa.Column('payer_creditor_id', sa.BigInteger(), nullable=False),
    sa.Column('payer_payment_order_seqnum', sa.Integer(), nullable=False, comment='A number generated by the payer. It is used to distinguish between potentially many payment orders issued against one offer.'),
