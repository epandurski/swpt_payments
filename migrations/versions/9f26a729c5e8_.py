...
Revision ID: 9f26a729c5e8
Revises: 953d40d6b4e6
Create Date: 2019-09-01 17:01:48.055534
...
def upgrade():
    ...
    sa.Column('offer_announcement_id', sa.BigInteger(), nullable=False, comment='A number generated by the payee. Must be different for each offer announced by a given payee.'),
